...
#    input_filename = input('path to sleepcycle dataset (./sleepdata.csv): ') or 'sleepdata.csv'
    input_filename = 'C:/Users/Dawid/OneDrive/Documents/STUDIA Onedrive/SEMESTR6/Bionika/projekt/gotowe11.csv';
    output_file = 'C:/Users/Dawid/OneDrive/Documents/STUDIA Onedrive/SEMESTR6/Bionika/projekt/gotowe.pkl';
    with open(output_file, 'w') as outfile, open(input_filename,'r',encoding='utf-8') as infile:
